...
console.log("HelloInstance does not have message2 variable in its prototype, but HelloWorld does. So we access it");
...
console.log("Look at the differences in prototypes. As there are none the objects are separate. Rather than having ONE object of multiple types, prototype inheritance creates a compound object from multiple distinct objects connected by .prototype variable.")
console.log(inheritanceObject);
console.log(anotherObject);
console.log(inheritanceObject.myFunction())
console.log(anotherObject.myFunction());
